			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>List of Tenants and LandLords</b>
					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$tenant = $conn->query("SELECT t.*,concat(t.lastname,'. ',t.firstname,' ',t.middlename,' (',h.description,')') as name,h.house_no,h.price FROM tenants t inner join houses h on h.id = t.house_id where t.status = 1 order by h.house_no desc ");
