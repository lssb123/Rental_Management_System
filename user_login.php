  		...
  		<div id="login-right" class="bg-light">
			...
			<br>
  			<div class="card col-md-8">
  				<div class="card-body">
  					<form id="login-form" name="f1" action = "authentication.php" onsubmit = "return validation()" method = "POST">
						...
						<!-- <center><p style="margin-top:10px;">Existing tenant? <a href="user_login.php"><u>login here</u></a></p></center> -->
  					</form>
  				</div>
  			</div>
  			</div>
