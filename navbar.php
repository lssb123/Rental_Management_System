...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=tenants" class="nav-item nav-tenants"><span class='icon-field'><i class="fa fa-user-friends "></i></span> Tenants & LandLords</a>

				<!-- <a href="index.php?page=landlords" class="nav-item nav-tenants"><span class='icon-field'><i class="fa fa-user-friends "></i></span> Landlords</a> -->


				<a href="index.php?page=admin_complaints" class="nav-item nav-admin_complaints"><span class='icon-field'><i class="fa fa-user-complaints "></i></span> Complaints</a>
				<a href="index.php?page=message" class="nav-item nav-message"><span class='icon-field'><i class="fa fa-message "></i></span> Messaging</a>
