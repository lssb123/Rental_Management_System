...
<div class="container-fluid">
    <form action="" id="manage-payment">
        ...
        <div class="form-group">
            ...
            $tenant = $conn->query("SELECT t.*,concat(t.lastname,'. ',t.firstname,' ',t.middlename,' (',h.description,')') as name FROM tenants   t inner join houses h on h.id = t.house_id where t.status = 1 order by h.house_no desc ");
